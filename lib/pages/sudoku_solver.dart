          ...
          children: [
              ...
              onKey: (event) {
                if (event.runtimeType == RawKeyDownEvent) {
                  ...
                  if (key.keyId == LogicalKeyboardKey.arrowUp.keyId) {
                    _moveFocus(0, -1);
                  } else if (key.keyId == LogicalKeyboardKey.arrowDown.keyId) {
                    _moveFocus(0, 1);
                  } else if (key.keyId == LogicalKeyboardKey.arrowLeft.keyId) {
                    _moveFocus(-1, 0);
                  } else if (key.keyId == LogicalKeyboardKey.arrowRight.keyId) {
                    _moveFocus(1, 0);
            ...
            Wrap(
                ...
                children: [
                  ...List.generate(
                      9,
                      (index) => FloatingActionButton.small(
                            heroTag: index.toString(),
                            onPressed: () {
                              if (_selectedTile != null) {
                                setState(() {
                                  demo[_selectedTile!['row']!]
                                      [_selectedTile!['column']!] = index + 1;
                                });
                              }
                            },
